...
ID='16' RECORD='webmail' TYPE='CNAME' PRIORITY='' VALUE='webmail.HOST_DOMAIN.' SUSPENDED='no' TIME='%time%' DATE='%date%'
ID='17' RECORD='@' TYPE='MX' PRIORITY='0' VALUE='HOST_DOMAIN.' SUSPENDED='no' TIME='%time%' DATE='%date%'
...
ID='21' RECORD='_autodiscover._tcp' TYPE='SRV' PRIORITY='10 10 443' VALUE='autodiscover.HOST_DOMAIN.' SUSPENDED='no' TIME='%time%' DATE='%date%'

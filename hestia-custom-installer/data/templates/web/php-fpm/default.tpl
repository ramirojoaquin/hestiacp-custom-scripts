...
pm = dynamic
pm.max_children = PHPFPM_DEFAULT_MAX_CHILDRENS
pm.start_servers = PHPFPM_DEFAULT_START
pm.min_spare_servers = PHPFPM_DEFAULT_MIN_SPARE
pm.max_spare_servers = PHPFPM_DEFAULT_MAX_SPARE
pm.max_requests = PHPFPM_DEFAULT_REQS
pm.process_idle_timeout = PHPFPM_DEFAULT_TIMEOUT

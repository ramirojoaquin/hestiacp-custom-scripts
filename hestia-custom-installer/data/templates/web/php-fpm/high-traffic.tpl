...
pm = dynamic
pm.max_children = PHPFPM_BIG_MAX_CHILDRENS
pm.start_servers = PHPFPM_BIG_START
pm.min_spare_servers = PHPFPM_BIG_MIN_SPARE
pm.max_spare_servers = PHPFPM_BIG_MAX_SPARE
pm.max_requests = PHPFPM_BIG_REQS
pm.process_idle_timeout = PHPFPM_BIG_TIMEOUT

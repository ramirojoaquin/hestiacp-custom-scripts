...
echo "- Habilitamos el plan default para admin"
...
cp $CURRENT_DIR/../$CLIENT_DATA_DIR/favicon.ico $HESTIA_IMAGES_DIR/favicon.ico
cp $CURRENT_DIR/../$CLIENT_DATA_DIR/logo.svg $HESTIA_IMAGES_DIR/logo.svg
cp $CURRENT_DIR/../$CLIENT_DATA_DIR/logo-header.svg $HESTIA_IMAGES_DIR/logo-header.svg
